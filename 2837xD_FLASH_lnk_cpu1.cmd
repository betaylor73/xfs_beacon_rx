...
SECTIONS
{
   ...
   .cinit              : > FLASHB | FLASHC | FLASHD      PAGE = 0, ALIGN(8)
   ...
   .bss:cio            : > RAMGS6,       PAGE = 1
   .data               : > RAMGS6,       PAGE = 1
   .sysmem             : > RAMGS6,       PAGE = 1
   ...
   ramgs1           : > RAMGS1,     PAGE = 1
            ...
            SINETABLE : {} LOAD = FLASHF,
                        RUN = RAMLS345,
                        LOAD_START(SineTableLoadStart),
                        LOAD_SIZE(SineTableLoadSize),
                        LOAD_END(SineTableLoadEnd),
                        RUN_START(SineTableRunStart),
                        RUN_SIZE(SineTableRunSize),
                        RUN_END(SineTableRunEnd),
                        PAGE = 0, ALIGN(8)
        #else
            .TI.ramfunc : {} LOAD = FLASHD,
                             RUN = RAMLS0,
